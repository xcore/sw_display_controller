...
void main(){
	...
	par {
		...
		// CHOICE 1
		on tile[0]: chirp_wave(c_sig1, FFT_POINTS);
		on tile[0]: chirp_wave(c_sig2, FFT_POINTS/4);

		// CHOICE 2
//		on tile[0]: sine_wave(c_sig1, FFT_POINTS);
//		on tile[0]: chirp_wave(c_sig2, FFT_POINTS/4);

		// CHOICE 3
//		on tile[0]: sine_wave(c_sig1, FFT_POINTS);
//		on tile[0]: sine_wave(c_sig2, FFT_POINTS/4);
