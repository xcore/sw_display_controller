/*****************************************************************
Program: SDRAM single line write performance
...
void application(chanend c_server) {
      ...
      // Time computation for writing words of different size in one row
      for(unsigned n=1;n<=SDRAM_ROW_WORDS;n++){
    	  unsigned running  = 1;
    	  unsigned bytes_transfered = 0;
          col = 0;
          t:> t1;
          sdram_buffer_write(c_server, bank, row, col, n, buffer);
